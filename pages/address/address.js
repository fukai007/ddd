...
var addressm ={
  ...
  onAddressSubmit:function(){
    ...
    if (!addressInfo.telNumber){
      wx.showToast({ title: '未填手机号', image: "../../images/error-a.png" });
      return 
    }

    if (!addressInfo.proviceFirstStageName)  {
      wx.showToast({ title: '未填省份', image: "../../images/error-a.png" });
      return 
    }

    if (!addressInfo.addressCitySecondStageName) {
      wx.showToast({ title: '未填城市', image: "../../images/error-a.png" });
      return
    }

    if (!addressInfo.addressDetailInfo) {
      wx.showToast({ title: '未填详细地址', image: "../../images/error-a.png" });
      return
    }
